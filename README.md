...
- DW mode builder: build dim.v_<name> from stg table with select/rename/filter, preview data, validate BK quality, then execute utility.sp_create_T1_dimension_view_based_proc for dim.<name>
